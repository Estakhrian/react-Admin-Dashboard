            ...
            <div className='p-6'>
                <div className='space-y-4'>
                    {activities.map((item, index) => (
                        <div key={index} className='flex items-start space-x-4 p-3 rounded-lg hover:bg-slate-50
                    dark:hover:bg-slate-800/50 transition-colors'>
                            <div className={`p-2 rounded-lg ${item.bgColor}`}> <item.icon className={`w-4 h-4 ${item.color}`}/> </div>
