...
const Sidebar = ({ showSideBar, currentPage, onPageChanged }) => {
    ...
    relative z-10'`}>
            ...
            {/**navigation */}
            <nav className={`flex-1 overflow-y-auto ${showSideBar ? "space-y-2 p-1.5" : "space-y-5 p-3"}`}>
                {menuItems.map((item) => (
                        ...
                        <button className={`w-full flex items-center justify-start p-1 rounded-xl
                            ...
                            <div className='flex items-center space-x-1 '>
                                ...
                                <>
                                    {showSideBar && (
                                        <div>
                                            <span className='text-xs sm:text-sm  font-semibold mx-1 py-1'>{item.label}</span>
            ...
            {/* *User profile */}
            {showSideBar && (
                <div className={`w-full  border-t border-slate-400/50 bg-white/60 dark:bg-slate-900/80 transition-all duration-500 ${showSideBar && "mb-16 sm:mb-12 md:mb-5"}`}>
